...
<html>
  ...
  <body>
    ...
    <section
      ...
      id="page7-header3-0"
      style="background-color: gray; padding-top: 6.5rem;"
    >
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            ...
            <p style="text-align: center;">
              We bring to light stories of the campus residents who have been
              responsible for the smooth functioning of this institute.
            </p>
          </div>
        </div>
      </div>
...
for ($i=46; $i >= 1; $i--) { $line = fgets($file); $img = "
    ...
    <section
      ...
      id="EO-msg-box5-0"
      style="background-color: rgb(20,20,20); padding-top: 20px; padding-bottom: 20px;"
    >
      <div class="container">
        <div class="row">
    ...
    <section
      class="mbr-section mbr-section__container"
      id="page7-header3-0"
      style="background-color: rgb(255, 255, 255); padding-top: 1.75rem;"
    >
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            <h4
              class="mbr-section-title "
              style="font-size: 2rem; padding-top: 0.5rem;"
            >
              Visit our
              <a
                href="https://www.facebook.com/nssiitbombay/photos/?tab=album&album_id=988090541219125"
                >facebook page</a
              >
              for more..
            </h4>
