...
$dept_data="SELECT * FROM department_data WHERE department = 'EO'" ;
$dept_basic = "SELECT * FROM department_basics WHERE department = 'GC";
$basic_data = $conn->query($sql);
...
<?php echo("<script>");
while($data = $basic_data->fetch_assoc()){
    echo("console.log( basicdata: , $data);");
}
echo("</script>");
?>
</head>
