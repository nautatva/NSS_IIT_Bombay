        ...
        <?php
            ...
            echo '
                        ...
                        <div class="s-12 m-12 l-6 ">
                         ...
                         ';
                         if($page!=0)
                         echo '<a href="class.php?c='.$_GET["c"].'&page='.($page - 1).'&t='.$rowcount.'"><button class="button background-primary border-radius text-white text-strong">< Previous Page </button></a>';
                       echo'
                     </div>
                     </div>
                     <div class="s-12 m-12 l-6 ">
                         ...
                         echo '<a href="class.php?c='.$_GET["c"].'&page='.($page + 1).'&t='.$rowcount.'"><button class="button background-primary border-radius text-white text-strong"> Next Page > </button></a>';
                       echo'
                     </div>
                     </div>
                       </div>
