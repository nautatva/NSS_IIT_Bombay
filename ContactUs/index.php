            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-xs-center">
                        ...
                        <small class="mbr-section-subtitle">Your feedbacks and suggestions are most welcome.</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-lg-10 col-lg-offset-1" data-form-type="formoid">
                        ...
                        <form action="./index.php" method="post" data-form-title="CONTACT FORM">

                            <input type="hidden" value="suhw6JlcfrOIDZHDbbxfVIvZjC/a5Pvtw6K/kxSlmKNJJ38WzR056XOHmSBu5Lh/GA+L4HAHys54H2MnhZNDM7cupewijPdwr2YEUdPtD0GNkSskNIyQ/3d8AD59tjwY"
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="email" required=""
                                            data-form-field="Email" id="index-form1-0-email">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="form-control-label" for="index-form1-1-message">Suggestions </label>
                                <textarea class="form-control" name="message" rows="5" data-form-field="Suggestions" id="index-form1-1-message"></textarea>
                            </div>
                            <div class="form-group">
                                <label class="form-control-label" for="index-form1-1-message">Feedback </label>
                                <textarea class="form-control" name="message" rows="5" data-form-field="Feedback" id="index-form1-2-message"></textarea>
                            </div>
