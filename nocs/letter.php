...
<body>
	...
	<a href="../index.html" class="navbar-logo">
		<img src="../images/iitb.png" style="padding-top:60px;padding-left:50px;position:fixed;" alt="IITB">
	</a>
	<a href="../index.html" class="navbar-logo">
		<img src="../assets/images/logo128.png" style="padding-left:205px;padding-top:80px;position:fixed;" alt="NSS">
	</a> -->
	<section class="cd-faq">
		<!-- <ul class="cd-faq-categories is-fixed" id="kry"> -->
		<!-- <li>
				<a class="NOCS" href="index.html">Back to NOCS Page</a>
			</li>
			<li>
				<a class="NOCS" href="../index.html">NSS IIT Bombay Home</a>
			</li>
		</ul> -->
				...
				<li>
					<div style="display: flex;">
						...
						<div style="width: 100%; display: flex; flex-direction: row-reverse;">
							<a href="./index.html" style="padding: 24px 72px 24px 24px; color: #561b8c">Back to NOCS page</a>
						</div>
					</div>
