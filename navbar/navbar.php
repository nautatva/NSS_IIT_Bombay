          ...
          <div class="cbp-hrsub-inner">
            <div class="part1">
              <div class="nav-mobile">
                <a href="#">Departments<i class="icon arrow-down"> &#xe800; </i></a>
                <ul>
                  <li>
              ...
              <div class="nav-mobile">
                <a href="#">Youtube <i class="icon arrow-down"> &#xe800; </i></a>
                <ul>
                  <li>
                    <a
              ...
              <div class="nav-mobile">
                <a href="#">Portals<i class="icon arrow-down"> &#xe800; </i></a>
                <ul>
                  <li>
              ...
              <div class="nav-mobile">
                <a href="#">Blogs<i class="icon arrow-down"> &#xe800; </i></a>
                <ul>
                  <li>
                    <a
            ...
            <div class="part2">
              <div class="nav-mobile">
                <a href="#">About Us<i class="icon arrow-down"> &#xe800; </i></a>
                <ul>
                  <li>
              ...
              <div class="nav-mobile">
                <a href="#">Impacting Lives<i class="icon arrow-down"> &#xe800; </i></a>
                <ul>
                  <li>
                    <a href="#">Stories of change</a>
                  </li>
                  <li>
                    <a href="#">My NSS experiences</a>
                  </li>
                  <li>
                    <a href="https://gymkhana.iitb.ac.in/~nss/ContactUs.php">
              ...
              <div class="nav-mobile">
                <a href="#">Resources<i class="icon arrow-down"> &#xe800; </i></a>
                <ul>
                  <li>
